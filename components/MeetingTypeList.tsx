...
const MeetingTypeList = () => {
  ...
  const [meetingState, setMeetingState] = useState<
    "isScheduleMeeting" | "isJoiningMeeting" | "isInstanceMeeting" | undefined
  >();
  const { user } = useUser();
    ...
    <section className="grid grid-cols-1 gap-5 md:grid:cols-2 xl:grid-cols-4">
      ...
      >
        <Input
          ...
          className="border-none bg-dark-3 focus-visible:ring-0 focus-visible:ring-offest-0"
